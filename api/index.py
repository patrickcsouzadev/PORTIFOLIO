...
@app.get("/api")
def read_root():
    """Esse endpoint e so pra eu bater e conferir rapido se a API subiu direito na Vercel.

Ele devolve um json simples com status, versao e lista de rotas principais.
Uso isso pra monitoramento e tambem pra teste rapido quando algo quebra no deploy."""
    return {
        "status": "online",
